...
public class NotificationProcessor {
	...
	public void showSysAnnounceNotifications(final HTTPRequestContext context, final HttpServletRequest request,
		...
		final JSONObject result = notificationQueryService.getSysAnnounceNotifications(avatarViewMode, userId, pageNum,
				pageSize);
		...
		dataModel.put("watchingArticleCnt", watchingArticleCnt);

//		for (final JSONObject notification : notifications) {
//			System.out.println("SysAnnounce:"+notification.getInt(Notification.NOTIFICATION_DATA_TYPE));
//		}
	 ...
	 *            the specified response
	 * @param type
	 *            the specified type: "commented"/"at"/"following"
	 * @throws Exception
	 *             exception
	 */
	...
	public void navigateNotifications(final HTTPRequestContext context, final HttpServletRequest request,
		...
		final int unreadCommentedNotificationCnt = notificationQueryService.getUnreadNotificationCountByType(userId,
		...
		final int unreadReplyNotificationCnt = notificationQueryService.getUnreadNotificationCountByType(userId,
		...
		final int unreadAtNotificationCnt = notificationQueryService.getUnreadNotificationCountByType(userId,
				Notification.DATA_TYPE_C_AT)
				+ notificationQueryService.getUnreadNotificationCountByType(userId,
		...
		final int unreadBroadcastCnt = notificationQueryService.getUnreadNotificationCountByType(userId,
...
//		for (final JSONObject notification : pointNotifications) {
//			System.out.println("point:"+notification.getInt(Notification.NOTIFICATION_DATA_TYPE));
//		}
	...
	private void fillNotificationCount(final String userId, final Map<String, Object> dataModel) {
		...
		final int unreadBroadcastNotificationCnt = notificationQueryService.getUnreadNotificationCountByType(userId,
				Notification.DATA_TYPE_C_BROADCAST);
		dataModel.put(Common.UNREAD_BROADCAST_NOTIFICATION_CNT, unreadBroadcastNotificationCnt);

		final int unreadSysAnnounceNotificationCnt = notificationQueryService
				.getUnreadSysAnnounceNotificationCount(userId);
		dataModel.put(Common.UNREAD_SYS_ANNOUNCE_NOTIFICATION_CNT, unreadSysAnnounceNotificationCnt);

		final int unreadNewFollowerNotificationCnt = notificationQueryService.getUnreadNotificationCountByType(userId,
				Notification.DATA_TYPE_C_NEW_FOLLOWER);
		dataModel.put(Common.UNREAD_NEW_FOLLOWER_NOTIFICATION_CNT, unreadNewFollowerNotificationCnt);

		dataModel.put(Common.UNREAD_NOTIFICATION_CNT,
				unreadAtNotificationCnt + unreadBroadcastNotificationCnt + unreadCommentedNotificationCnt
						+ unreadFollowingNotificationCnt + unreadPointNotificationCnt + unreadReplyNotificationCnt
						+ unreadSysAnnounceNotificationCnt + unreadNewFollowerNotificationCnt);
	}
	...
	public void showCommentedNotifications(final HTTPRequestContext context, final HttpServletRequest request,
		...
		final JSONObject result = notificationQueryService.getCommentedNotifications(avatarViewMode, userId, pageNum,
				pageSize);
...
//		for (final JSONObject notification : commentedNotifications) {
//			System.out.println("commented:"+notification.getInt(Notification.NOTIFICATION_DATA_TYPE));
//		}
	...
	public void showReplyNotifications(final HTTPRequestContext context, final HttpServletRequest request,
		...
		final JSONObject result = notificationQueryService.getReplyNotifications(avatarViewMode, userId, pageNum,
				pageSize);
...
//		for (final JSONObject notification : replyNotifications) {
//			System.out.println("reply:"+notification.getInt(Notification.NOTIFICATION_DATA_TYPE));
//		}
	...
	public void showAtNotifications(final HTTPRequestContext context, final HttpServletRequest request,
		...
		final JSONObject result = notificationQueryService.getAtNotifications(avatarViewMode, userId, pageNum,
				pageSize);
...
//			System.out.println("at:"+notification.getInt(Notification.NOTIFICATION_DATA_TYPE));
		}
	...
	public void showFollowingNotifications(final HTTPRequestContext context, final HttpServletRequest request,
		...
		final JSONObject result = notificationQueryService.getFollowingNotifications(avatarViewMode, userId, pageNum,
				pageSize);
...
//		for (final JSONObject notification : followingNotifications) {
//			System.out.println("following:"+notification.getInt(Notification.NOTIFICATION_DATA_TYPE));
//		}
	...
	public void showBroadcastNotifications(final HTTPRequestContext context, final HttpServletRequest request,
		...
		final JSONObject result = notificationQueryService.getBroadcastNotifications(avatarViewMode, userId, pageNum,
				pageSize);
...
//		for (final JSONObject notification : broadcastNotifications) {
//			System.out.println("broadcast:"+notification.getInt(Notification.NOTIFICATION_DATA_TYPE));
//		}
	...
	public void getUnreadNotificationCount(final HTTPRequestContext context, final HttpServletRequest request,
		...
		context.renderJSON(new JSONObject(dataModel)).renderTrueResult().renderJSONValue(UserExt.USER_NOTIFY_STATUS,
