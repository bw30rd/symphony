        ...
        <div class="main">
            <div class="wrapper verify">
                <div class="verify-wrap">
                    <div class="form">
                        <p style="text-align:center;"><img src="${staticServePath}/images/logo.png" style="width:100px; height:100px;"></p>						
                        ...
                        <button class="blue" onclick="Verify.login('${goto}')">${loginLabel}</button>
