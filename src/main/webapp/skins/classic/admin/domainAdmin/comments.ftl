        ...
        <ul>
            ...
            <li>
                <div class="fn-flex">
                    ...
                    <a href="${servePath}/domainAdmin/${domain.domainURI}/comment/${item.oId}" class="fn-right tooltipped tooltipped-e ft-a-title" aria-label="${editLabel}"><span class="icon-edit"></span></a>
                </div>
            </li>
            </#list>
        </ul>
        <@pagination url="${servePath}/domainAdmin/${domain.domainURI}/comments"/>
    </div>
</div>
</@admin>