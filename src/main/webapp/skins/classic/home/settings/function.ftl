...
<div class="module">
    ...
    <div class="module-panel form fn-clear">
        ...
        <button class="fn-right blue" onclick="Settings.update('function', '${csrfToken}')">${saveLabel}</button>
    </div>
</div>
...
<div class="module">
    ...
    <div class="module-panel form fn-clear">
        ...
        <div class="fn-hr5"></div>
        <button class="fn-right blue" onclick="Settings.update('emotionList', '${csrfToken}')">${saveLabel}</button>
    </div>
</div>
</@home>
<script>
