...
<html>
    ...
    <body>
            ...
            <div class="form fn-flex-1 fn-clear">
                ...
                <div class="tags-wrap">
                    <div class="tags-input"><span class="tags-selected"></span>
                   		<input id="articleTags" type="text" readonly="readonly" tabindex="3"<#if requisite> readonly disabled</#if>
	                    ...
	                    <div class="domains-tags">
	                     	<#list addArticleDomains as domain>
	                            <#if domain.domainTags?size gt 0>
	                                <span data-id="${domain.oId}" class="btn small<#if 0 == domain_index> current blue</#if>">${domain.domainTitle}</span>&nbsp;
	                            </#if>
	                        </#list>
                ...
                <br/>
                <div class="fn-clear wrapper nowrapper">
                    <#if !articleType??>
                  ...
                  <#--  <span class="icon-article"></span> ${articleLabel}-->
                    ...
                    <div class="fn-right nofloat anonymous">
                        ...
                        <label class="article-anonymous"<#if !permissions["commonAddArticleAnonymous"].permissionGrant>style="display: none;"</#if>>${anonymousLabel}<input<#if requisite> readonly disabled</#if>
                        ...
                        <#if article??>
                            ...
                            <button class="blue subBtn" id="addArticleBtn" tabindex="10"<#if requisite> readonly disabled</#if>
        ...
        <script>
            ...
            Label.tagSeparatorTipLabel = '${tagSeparatorTipLabel}';
