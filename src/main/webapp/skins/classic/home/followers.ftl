        ...
        <li<#if !(paginationPageCount?? && paginationPageCount!=0 && paginationPageCount!=1) && follower_index == userHomeFollowerUsers?size - 1>
            ...
            <div class="fn-flex">
                ...
                <div class="fn-flex-1">
                    ...
                    <button class="fn-right mid followed" onclick="Util.unfollow(this, '${follower.oId}', 'user')"> 
                        ${unfollowLabel}
                    </button>
                    <#else>
                    <button class="fn-right mid follow" onclick="Util.follow(this, '${follower.oId}', 'user')"> 
                        ${followLabel}
                    </button>
                    </#if>
                    </#if>
